...
(function () {
  ...
  window.Parsley.addValidator('creditcard',
    ...
    .addMessage('fr', 'creditcard', "Le numéro de carte de crédit est invalide ou la compagnie de la carte de crédit n'est pas supportée");
  ...
  window.Parsley.addValidator('cvv',
    ...
    .addMessage('fr', 'cvv', 'Cette valeur doit être un numéro CVC valide');
  ...
  window.Parsley.addValidator('expirydate',
    ...
    .addMessage('fr', 'expirydate', 'Cette valeur doit être une date valide');
}());